...
## 📖 About Me
My journey in engineering is driven by the challenge of making machines "see" and "think" in real-time.

My technical narrative is defined by versatility. I've controlled optical systems at UT Dallas, and developed UAV simulations using ROS 2 and Gazebo. I thrive in the "hands-on" phase of development—whether that’s debugging a PCB or tuning a PID controller for a quadruped. 
